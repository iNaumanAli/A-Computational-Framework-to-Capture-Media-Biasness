...
path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC GEO PMLN.csv"
...
#Saving it to the csv file 
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL GEO PMLN.csv',index=False)

"""## Read Labeled File"""

path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL GEO PMLN.csv"
...
plt.title("GEO PMLN Bar", fontsize = 16)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/GEO PMLN Bar.png")
...
plt.axis('off')
plt.title("GEO PMLN Percentage", fontsize = 16)
plt.legend()
#plt.axis('equal')
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/GEO PMLN Percent.png")
...
def get_report(trained_model,X, y, model_name):
    ...
    plt.title('GEO PMLN '+model_name+" Confusion Matrix", fontsize = 16)
    plt.savefig('/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/GEO PMLN '+model_name+' Confusion Matrix.png')
    plt.show()
...
color = sns.color_palette('bright')
plt.title("GEO PMLN Models Performance Comparison", fontsize = 16)
chart = sns.barplot(x='Model', y='Percentage Score', hue='', data=df, palette = color)
plt.legend(loc='center right')
for container in chart.containers:
  chart.bar_label(container)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/GEO PMLN Models Performance Comparison.png")
plt.show()
...
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY GEO Word Cloud.png")
plt.show()
