...
path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC ARY PPP.csv"
...
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC ARY PPP.csv',index=False)
...
#Saving it to the csv file 
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL ARY PPP.csv',index=False)

"""## Read Labeled File"""

path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL ARY PPP.csv"
...
plt.title("ARY PPP Bar", fontsize = 16)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PPP Bar.png")
...
plt.axis('off')
plt.title("ARY PPP Percentage", fontsize = 16)
plt.legend()
#plt.axis('equal')
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PPP Percent.png")
...
def get_report(trained_model,X, y, model_name):
    ...
    plt.title('ARY PPP '+model_name+" Confusion Matrix", fontsize = 16)
    plt.savefig('/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PPP '+model_name+' Confusion Matrix.png')
    plt.show()
...
color = sns.color_palette('bright')
plt.title("ARY PPP Models Performance Comparison", fontsize = 16)
chart = sns.barplot(x='Model', y='Percentage Score', hue='', data=df, palette = color)
plt.legend(loc='center right')
for container in chart.containers:
  chart.bar_label(container)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PPP Models Performance Comparison.png")
plt.show()
...
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PPP Word Cloud.png")
plt.show()
