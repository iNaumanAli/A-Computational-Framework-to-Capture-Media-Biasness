...
path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL GEO PTI.csv"
...
#Saving it to the csv file 
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL GEO PTI.csv',index=False)
...
plt.title("GEO PTI Bar", fontsize = 16)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/GEO PTI Bar.png")
...
plt.axis('off')
plt.title("GEO PTI Percentage", fontsize = 16)
plt.legend()
#plt.axis('equal')
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/GEO PTI Percent.png")
...
def get_report(trained_model,X, y, model_name):
    ...
    plt.title('GEO PTI '+model_name+" Confusion Matrix", fontsize = 16)
    plt.savefig('/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/GEO PTI '+model_name+' Confusion Matrix.png')
    plt.show()
...
color = sns.color_palette('bright')
plt.title("GEO PTI Models Performance Comparison", fontsize = 16)
chart = sns.barplot(x='Model', y='Percentage Score', hue='', data=df, palette = color)
plt.legend(loc='center right')
for container in chart.containers:
  chart.bar_label(container)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/GEO PTI Models Performance Comparison.png")
plt.show()
...
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/GEO PTI Word Cloud.png")
plt.show()
