...
pip install pandas nltk wordcloud emoji textblob
...
path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC 24 News PPP.csv"
...
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC 24 News PPP.csv',index=False)
...
#Saving it to the csv file 
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL 24 News PPP.csv',index=False)

"""## Read Labeled File"""

path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL 24 News PPP.csv"
data = pd.read_csv(path)
data

"""## Emotions Count Graph"""

count_values = data['Emotion'].value_counts()
sns.set(style = "whitegrid", font_scale = 1.1)
plt.figure(figsize = (9,6))
color = sns.color_palette('bright')
ax = sns.barplot(count_values.index, count_values.values, palette = color)
ax.set(xlabel = 'Emotions', ylabel = 'Emotions Count')
for container in ax.containers:
  ax.bar_label(container)
plt.title("24 News PPP Bar Chart", fontsize = 16)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Work/Results Images/24 News PPP Bar Chart.png")

"""## Emotions Percentage Graph"""

data2 = data["Emotion"].value_counts()
color = sns.color_palette('bright')
explode = [0.01, 0.01, 0.01, 0.01, 0.01, 0.01]
data2.plot.pie(autopct = "%.2f%%", colors = color, fontsize = 14, explode = explode, figsize = (10,8))
plt.axis('off')
plt.title("24 News PPP Emotion Percentage", fontsize = 16)
plt.legend()
#plt.axis('equal')
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Work/Results Images/24 News PPP Emotion Percentage.png")
...
def get_report(trained_model,X, y, model_name):
    ...
    plt.title('24 News PPP '+model_name+" Confusion Matrix", fontsize = 16)
    plt.savefig('/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 News PPP '+model_name+' Confusion.png')
    plt.show()
...
color = sns.color_palette('bright')
plt.title("24 News PPP Models Performance Comparison", fontsize = 16)
chart = sns.lineplot(x='Model', y='Percentage Score', hue='', data=df, palette = color)
plt.legend(loc='center right')
for container in chart.containers:
  chart.bar_label(container)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 News PPP Models Performance Comparison.png")
plt.show()
...
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 PPP News Word Cloud.png")
plt.show()
