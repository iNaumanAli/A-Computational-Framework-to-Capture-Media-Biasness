...
Original file is located at
    https://colab.research.google.com/drive/1ujmHzgS6YTWIp2kvIdqGRB0R6DrLbD79
...
path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC ARY PTI.csv"
...
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC ARY PTI.csv',index=False)
...
path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL ARY PTI.csv"
...
plt.title("ARY PTI Bar", fontsize = 16)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PTI Bar.png")
...
plt.axis('off')
plt.title("ARY PTI Percentage", fontsize = 16)
plt.legend()
#plt.axis('equal')
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PTI Percent.png")
...
def get_report(trained_model,X, y, model_name):
    ...
    plt.title('ARY PTI '+model_name+" Confusion Matrix", fontsize = 16)
    plt.savefig('/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PTI '+model_name+' Confusion Matrix.png')
    plt.show()
...
color = sns.color_palette('bright')
plt.title("ARY PTI Models Performance Comparison", fontsize = 16)
chart = sns.barplot(x='Model', y='Percentage Score', hue='', data=df, palette = color)
plt.legend(loc='center right')
for container in chart.containers:
  chart.bar_label(container)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PTI Models Performance Comparison.png")
plt.show()
...
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PTI Word Cloud.png")
plt.show()
