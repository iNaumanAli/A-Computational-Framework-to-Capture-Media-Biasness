...
path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC 24 News PTI.csv"
...
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC 24 News PTI.csv',index=False)
...
#Saving it to the csv file 
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL 24 News PTI.csv',index=False)

"""## Read Labeled File"""

path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL 24 News PTI.csv"
...
plt.title("24 News PTI Bar Chart", fontsize = 16)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Work/Results Images/24 News PTI Bar Chart.png")
...
plt.axis('off')
plt.title("24 News PTI Emotion Percentage", fontsize = 16)
plt.legend()
#plt.axis('equal')
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Work/Results Images/24 News PTI Emotion Percentage.png")
...
def get_report(trained_model,X, y, model_name):
    ...
    plt.title('24 News PTI '+model_name+" Confusion Matrix", fontsize = 16)
    plt.savefig('/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 News PTI '+model_name+' Confusion.png')
    plt.show()
...
color = sns.color_palette('bright')
plt.title("24 News PTI Models Performance Comparison", fontsize = 16)
chart = sns.lineplot(x='Model', y='Percentage Score', hue='', data=df, palette = color)
plt.legend(loc='center right')
for container in chart.containers:
  chart.bar_label(container)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 News PTI Models Performance Comparison.png")
plt.show()
...
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 News PTI Word Cloud.png")
plt.show()
