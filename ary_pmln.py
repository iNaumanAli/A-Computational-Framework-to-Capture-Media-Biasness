...
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PMLN Word Cloud.png")
plt.show()
...
path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL ARY News PMLN.csv"
#path="/content/AL GEO PMLN.csv"
...
plt.axis("off")
plt.tight_layout(pad=0)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 NEWS PMLN Word Cloud.png")
plt.show()
...
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC ARY PMLN.csv',index=False)
...
#Saving it to the csv file 
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL ARY PTI.csv',index=False)

"""## Read Labeled File"""

path = "/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL ARY PMLN.csv"
...
color = sns.color_palette('bright')
plt.title("ARY PMLN Models Performance Comparison", fontsize = 16)
chart = sns.barplot(x='Model', y='Percentage Score', hue='', data=df, palette = color)
plt.legend(loc='center right')
for container in chart.containers:
  chart.bar_label(container)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/ARY PMLN Models Performance Comparison.png")
plt.show()
