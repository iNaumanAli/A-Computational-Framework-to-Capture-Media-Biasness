...
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Cleaning/AC 24 News PMLN.csv',index=False)
...
#Saving it to the csv file 
data.to_csv('/content/drive/Othercomputers/My Laptop/Thesis Data/After Labeling/AL 24 News PMLN.csv',index=False)
...
count_values = data['Tweets'].value_counts()
party1=data['Party']
sns.set(style = "whitegrid", font_scale = 1.1)
plt.figure(figsize = (9,6))
color = sns.color_palette('bright')
ax = sns.barplot(x=data['Party'], y=count_values, hue=data['Analysis'].value_counts())
ax.set(xlabel = 'Labels', ylabel = 'Labels Count')
for container in ax.containers:
  ax.bar_label(container)
plt.title("24 News Bar", fontsize = 16)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Group Graph/24 News.png")
...
plt.axis('off')
plt.title("24 News PMLN Percentage", fontsize = 16)
plt.legend()
#plt.axis('equal')
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 News PMLN Percent.png")
...
def get_report(trained_model,X, y, model_name):
    ...
    plt.title('24 News PMLN '+model_name+" Confusion Matrix", fontsize = 16)
    plt.savefig('/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 News PMLN '+model_name+' Confusion.png')
    plt.show()
...
color = sns.color_palette('bright')
plt.title("24 News PMLN Models Performance Comparison", fontsize = 16)
chart = sns.lineplot(x='Model', y='Percentage Score', hue='', data=df, palette = color)
plt.legend(loc='center right')
for container in chart.containers:
  chart.bar_label(container)
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 News PMLN Models Performance Comparison.png")
plt.show()
...
plt.savefig("/content/drive/Othercomputers/My Laptop/Thesis Data/Results Images/24 News Word Cloud.png")
plt.show()
